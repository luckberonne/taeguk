  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
      <h2 className="font-bold text-xl text-neutral-800 dark:text-neutral-200">
        Inscripción a Clases de Taekwondo
      </h2>
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
        ¡Bienvenido a nuestra academia de Taekwondo! Por favor, completa el formulario de inscripción.
      </p>

      <form className="my-8" onSubmit={handleSubmit}>
        <LabelInputContainer>
          <Label htmlFor="nombre">Nombre</Label>
          <Input id="nombre" placeholder="Juan" type="text" />
        </LabelInputContainer>
        <LabelInputContainer>
          <Label htmlFor="apellido">Apellido</Label>
          <Input id="apellido" placeholder="Pérez" type="text" />
        </LabelInputContainer>
        <LabelInputContainer>
          <Label htmlFor="telefono">Teléfono</Label>
          <Input id="telefono" placeholder="555-555-5555" type="tel" />
        </LabelInputContainer>
        <LabelInputContainer>
          <Label htmlFor="experiencia">Experiencia en Taekwondo</Label>
          <select id="experiencia" className="border rounded-md p-2" defaultValue="">
            <option value="">Selecciona una opción</option>
            <option value="nunca">Nunca he practicado Taekwondo</option>
